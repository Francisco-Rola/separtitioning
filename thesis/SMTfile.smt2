...
(assert (= phi_1 (and (bvult districtid #b00000000000000000000000000001010)(bvult warehouseid #b00000000000000000000000000000001))))
(assert (= phi_2 (and (bvult districtidGV #b00000000000000000000000000001010)(bvult warehouseidGV #b00000000000000000000000000000001))))
