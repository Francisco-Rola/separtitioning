...
(assert (= rho_2 (bvadd districtid (bvmul warehouseid #b00000000000000000000000001100100))))
...
(assert (= phi_2 (and (bvult districtid #b00000000000000000000000000001010)(and (bvult #b00000000000000000000000000000000 warehouseid) (bvult warehouseid #b00000000000000000000000000000010)))))
